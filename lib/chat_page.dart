...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  void initState() {
    ...
    _model = GenerativeModel(
      ...
      TextPart('You are an assistant for women in pregnant and after birth'),
      TextPart('You only answer about pregnant and babies questions.'),
      TextPart('If a question is outside of your this context, inform the user.'),
      ])
    );
